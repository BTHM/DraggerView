package win99.com.miaogu9.catloadinglibrary;
...
public class CatLoadingView extends DialogFragment {
    ...
    /**
     * @return 自定义 检测dialog是否隐藏 显示为true
     */
    public boolean isShowing(){
        if (this != null && this.getDialog() !=null && this.getDialog().isShowing()) {
            LogUtil.d("tag","base.mLoadingView.isShowing()="+true);
            return true;
        }else{
            LogUtil.d("tag","base.mLoadingView.isShowing()="+false);
            return false;
        }
    }
}
